    ...
    <div class="container dashboard-content my-3">
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="applicationNameVersion" class="form-label">Application Name - Version</label>
          <input type="text" name="aname" value="" class="form-control" id="applicationNameVersion" />
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="companyName" class="form-label">Company Name</label>
          <input type="text" name="cname" class="form-control" id="companyName" />
        </div>
      </div>
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          ...
          <input type="text" name="tline" class="form-control" id="tagLine" />
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="logoPath" class="form-label">Logo Path</label>
          <input type="text" name="logo" class="form-control" id="logoPath" />
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
