...
<div class="container dashboard-content text-center text-primary my-3">
      <div class="border-bottom mb-3 py-2 d-flex">
        <h4>Vacancy</h4>
        <a href="vacancy" class="text-primary text-decoration-none p-2 border text-center ms-auto">Add New</a>  
      </div>
        ...
        <table class="table">
          ...
          <c:forEach var="e" items="${vk}">
          <tbody>
            <tr class="fs-6">
              <th scope="row">${e.vacancy_id}</th>
              <td>${e.position_name}</td>
              <td>${e.available_positions}</td>
              <td>${e.caption_text}</td>
              <td>${e.caption_sub_text}</td>
              <td>${e.creation}</td>
              <td>${e.status}</td>
              <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="viewV/${e.vacancy_id}">View</a></li>
