   ...
   <div class="container dashboard-content my-3">
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          ...
          <select class="form-select" id="floatingSelect" name="section_name" required>
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="companyName" class="form-label">Content Name</label>
          <input type="text" name="content_name" class="form-control" id="companyName" required/>
        </div>
      </div>

      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="tagLine" class="form-label">Description</label>
          <input type="text" name="description" class="form-control" id="tagLine" />
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="tagLine" class="form-label">Created On</label>
          <input type="text" name="creation" class="form-control" id="tagLine" value="${date}" readonly />
        </div>
      </div>
