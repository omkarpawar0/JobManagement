...
<div class="container dashboard-content text-center text-primary my-3">
      <div class="border-bottom mb-3 py-2 d-flex">
        <h4>Section</h4>
        <a href="section" class="text-primary text-decoration-none p-2 border text-center ms-auto">Add New</a>  
      </div>
            ...
            <tr class="fs-6">
              ...
              <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="view?id=${e.id}">View</a></li>
                      <li><a class="dropdown-item" href="edit?id=${e.id}">Update</a></li>
                      <li><a class="dropdown-item" href="delete?id=${e.id}">Delete</a></li>
                    </ul>
                  </div>
              </td>
            </tr>
