...
<a href="admin" class="text-primary text-decoration-none p-2 border text-center">Logout</a>
    ...
    <div class="container dashboard-content my-3">
	  ...
	  <input type="hidden" name="employee_id" value="${ef.employee_id}" class="form-control" id="applicationNameVersion" />
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="applicationNameVersion" class="form-label"
            >Employee Name</label
          >
          <input type="text" name="employee_name" value="${ef.employee_name}" class="form-control" id="applicationNameVersion" />
        </div>
      </div>
        ...
        <div class="col-8 mb-3 mx-auto">
          <label for="applicationNameVersion" class="form-label"
            >Email</label
          >
          <input type="text" name="email" value="${ef.email}" class="form-control" id="applicationNameVersion" />
        </div>
      </div>
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          ...
          <input type="text" name="mobile" value="${ef.mobile}" class="form-control" id="companyName" />
        </div>
      </div>
        ...
        <div class="col-8 mb-3 mx-auto">
             <label class="form-label">Role</label>
              <select class="form-select" name="role" value="${ef.role}" id="floatingSelect" >
