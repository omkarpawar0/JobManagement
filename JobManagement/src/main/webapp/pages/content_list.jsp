...
<div class="container dashboard-content text-center text-primary my-3">
      <div class="border-bottom mb-3 py-2 d-flex">
        <h4>Content</h4>
        <a href="content" class="text-primary text-decoration-none p-2 border text-center ms-auto">Add New</a>  
      </div>
      <div class="table-content">
        <table class="table">
          ...
          <c:forEach var="e" items="${cc}">
          <tbody>
            <tr class="fs-6">
              <th scope="row">${e.section_id}</th>
              ...
              <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="viewC?id=${e.section_id}">View</a></li>
                      <li><a class="dropdown-item" href="edit1?id=${e.section_id}">Update</a></li>
                      <li><a class="dropdown-item" href="del?id=${e.section_id}">Delete</a></li>
                    </ul>
                  </div>
              </td>
            </tr>
